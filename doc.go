...
//
// The assertions in assert package are methods of the [Tester] type, which captures a [testing.TB] and can either call [testing.TB.Fail] or [testing.TB.FailNow] on failure depending on how you want the assertions to work.
//
